...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XTENSA_CACHED_REGION, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XTENSA_UNCACHED_REGION, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ESP_CUSTOM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TEST_EXTRA_STACK_SIZE, 768);
